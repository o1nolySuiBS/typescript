...
class UserService {
    // Приватна статична(1) константа для зберігання ключа, який використовується у localStorage
    private static readonly _userKey = 'users';
...
//1.-У TypeScript статичний метод (або статичний член) — це метод класу, який викликається без створення екземпляра цього класу. Статичні методи
// визначаються за допомогою ключового слова static перед визначенням методу. Вони належать до самого класу, а не до його екземплярів,
// і доступні через ім'я класу.